...
export class ClientService {
    ...
    getClientsByAdvanceSearch(businessId: string, phone: string, email: string) {
        return this.httpClient.get<ClientModel[]>(this.baseUrl + '/search/advanced', {
            params: {
    ...
    getClientsBySharedKey(sharedKey: string) {
        return this.httpClient.get<ClientModel[]>(this.baseUrl + '/search/' + sharedKey);
    }
